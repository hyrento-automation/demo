...
export const metadata: Metadata = {
  title: {
    default: 'Car Hire Mauritius | Luxury Car Rental — Island-Wide Delivery',
    template: '%s | Car Hire Mauritius',
  },
  ...
  authors: [{ name: 'Car Hire Mauritius' }],
  creator: 'Car Hire Mauritius',
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://carehireos.shop',
    siteName: 'Car Hire Mauritius',
    title: 'Car Hire Mauritius | Luxury Car Rental',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Car Hire Mauritius — Luxury Island Rentals',
      },
    ],
  },
  twitter: {
