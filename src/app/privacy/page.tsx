...
export const metadata = {
  ...
  description: 'Privacy Policy for Car Hire Mauritius',
};
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-navy/5 prose prose-navy max-w-none">
          <p className="lead text-lg text-mid-gray mb-8">
            At Car Hire Mauritius, we are committed to protecting your personal information and respecting your privacy. This policy outlines how we collect, use, and protect your data.
          </p>
