...
export const metadata = {
  ...
  description: 'Standard Rental Agreement for Car Hire Mauritius',
};
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-navy/5 prose prose-navy max-w-none">
          <p className="lead text-lg text-mid-gray mb-8">
            This Rental Agreement constitutes a legal contract between Car Hire Mauritius (the "Company") and the Renter. Please ensure you fully understand these conditions before signing at the time of vehicle pickup.
          </p>
