...
const CONTACT_ITEMS = [
  ...
  },
  {
    icon: MessageSquare,
    title: 'WhatsApp',
    detail: '+230 5702 0000',
    sub: 'Instant messaging — we reply in minutes',
    href: 'https://wa.me/2305702000',
    color: 'text-emerald-500', bg: 'bg-emerald-50',
  },
  {
    icon: Mail,
    title: 'Email Us',
    detail: 'info@carhiremauritius.com',
    sub: 'General enquiries & booking questions',
    href: 'mailto:info@carhiremauritius.com',
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="relative rounded-[2rem] overflow-hidden">
              ...
              <div className="absolute bottom-0 p-8">
                ...
                <a href="tel:+2305911000" className="text-gold font-black text-xl tracking-wider hover:underline">
                  +230 5911 0000
                </a>
              </div>
            </div>
