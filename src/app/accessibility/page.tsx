      ...
      <div className="max-w-4xl mx-auto px-6 space-y-12">
        ...
        <div className="prose prose-lg prose-navy max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2 my-6">
            <li>Phone: <a href={`tel:${process.env.NEXT_PUBLIC_BRAND_PHONE || '+23052553669'}`} className="text-gold hover:underline">{process.env.NEXT_PUBLIC_BRAND_PHONE || '+230 5255 3669'}</a></li>
