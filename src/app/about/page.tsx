...
export const metadata: Metadata = {
  title: 'About Us | Car Hire Mauritius — Island\'s Premier Car Rental',
  description: 'Founded in 2010, Car Hire Mauritius is the island\'s most trusted luxury car rental service. Learn our story, values, and commitment to excellence.',
};
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-32">
          <div className="max-w-2xl space-y-8">
            ...
            <p className="text-xl text-white/70 leading-relaxed">
              Born from a love of our island and a passion for exceptional service, Car Hire Mauritius has been redefining what it means to travel in Mauritius since 2010.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-mid-gray leading-relaxed">
              Founded in 2010, Car Hire Mauritius was born from a simple vision: to provide a car rental service that truly matches the unparalleled beauty and hospitality of our island.
            </p>
