...
export const metadata: Metadata = {
  title: `Our Locations | ${process.env.NEXT_PUBLIC_BRAND_NAME || 'Pleasure Drive Ltd'} — 4 Island-Wide Branches`,
  description: `${process.env.NEXT_PUBLIC_BRAND_NAME || 'Pleasure Drive Ltd'} operates from 5 strategic branches including SSR International Airport, Grand Baie, Port Louis Harbour, and Flic en Flac. Island-wide delivery available.`,
};
...
const LOCATIONS = [
  ...
  },
  {
    ...
    desc: 'Serving the north of the island. Ideal for villa deliveries, hotel handovers, and luxury sedan pickups.',
  ...
  },
  {
    ...
    desc: 'Located by the beautiful northern beaches. Perfect for resort guests and those exploring the coast.',
    features: ['Resort Delivery', 'Beach Pickups', 'North West'],
  ...
  },
  {
    ...
    whatsapp: '+230 5255 3669',
    hours: '09:00 – 17:00 Mon–Sat',
    desc: 'Serving the vibrant beach town of Pereybere. Quick and easy access to rental vehicles for beachgoers.',
    features: ['Quick Handover', 'Beach Pickups', 'North Coast'],
