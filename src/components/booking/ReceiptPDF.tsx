    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <Text style={styles.brandName}>{process.env.NEXT_PUBLIC_BRAND_NAME?.toUpperCase() || 'PLEASURE DRIVE LTD'}</Text>
        ...
        <View style={styles.headerRight}>
          ...
          <Text style={styles.refNumber}>Ref: {bookingRef || `${process.env.NEXT_PUBLIC_BOOKING_REF_PREFIX || 'PDL-'}XXXXXX`}</Text>
      ...
      <View style={styles.footer}>
        ...
        <Text style={styles.footerText}>For support, please call {process.env.NEXT_PUBLIC_BRAND_PHONE || '+230 5255 3669'} or email {process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'pleasuredriveltd@gmail.com'}</Text>
      </View>
